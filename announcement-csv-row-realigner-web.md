...
The file stays in the browser; there is no upload endpoint. The release includes full source, seven automated tests, synthetic before/after evidence, a README and an offline ZIP.
...
- Versioned ZIP: https://github.com/zhailong8845-art/csv-row-realigner-web/releases/tag/v1.0.0
